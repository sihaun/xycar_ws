...
# Local shortcut-driving copy of train_LaneFollowing.ipynb.
...
def build_parser():
    parser = argparse.ArgumentParser(description="Shortcut driving direction-vector training copied from train_LaneFollowing_local.py")
    parser.add_argument("--dataset-dir", default="Shortcut/shortcut_driving/dataset_xy")
    parser.add_argument("--best-model-path", default="Shortcut/shortcut_driving/best_shortcut_driving_direction.pth")
    parser.add_argument("--last-model-path", default="Shortcut/shortcut_driving/last_shortcut_driving_direction.pth")
