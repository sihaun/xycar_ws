...
class ConeDriveCapture(Node):

    def __init__(self, args):
        super().__init__("conedrive_dataset_capture")
        self.args = args
        ...
        self.get_logger().info(
            f"conedrive capture started: dir={self.dataset_dir} topic={args.topic} "
    ...
    def image_callback(self, msg):
        ...
        filename = f"conedrive_{ts_name}_{self.capture_id:06d}.jpg"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Append-only ROS2 front camera dataset capture for conedrive")
    parser.add_argument("--dataset-dir", default="Conedrive/raw_front_cam_dataset")
