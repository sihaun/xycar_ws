...
class FrontCamCapture(Node):

    def __init__(self, args):
        super().__init__("shortcut_driving_dataset_capture")
        self.args = args
        ...
        self.get_logger().info(
            f"append capture started: dir={self.dataset_dir} topic={args.topic} "
    ...
    def image_callback(self, msg):
        ...
        filename = f"shortcut_drive_{ts_name}_{self.capture_id:06d}.jpg"
...
def parse_args():
    ...
    parser.add_argument("--dataset-dir", default="Shortcut/shortcut_driving/raw_front_cam_dataset")
