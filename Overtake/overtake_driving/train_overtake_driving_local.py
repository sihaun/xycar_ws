...
def build_parser():
    parser = argparse.ArgumentParser(description="Train overtake front-camera direction-vector model")
    parser.add_argument("--dataset-dir", default="Overtake/overtake_driving/dataset_xy")
    parser.add_argument("--best-model-path", default="Overtake/overtake_driving/best_overtake_driving_direction.pth")
    parser.add_argument("--last-model-path", default="Overtake/overtake_driving/last_overtake_driving_direction.pth")
