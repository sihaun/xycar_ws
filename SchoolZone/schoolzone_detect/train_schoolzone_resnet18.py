...
def parse_args():
    parser = argparse.ArgumentParser(description="Train ResNet18 school zone front-camera classifier")
    parser.add_argument("--dataset-dir", default="SchoolZone/schoolzone_detect/dataset")
    parser.add_argument("--best-model-path", default="SchoolZone/schoolzone_detect/best_schoolzone_resnet18.pth")
    parser.add_argument("--last-model-path", default="SchoolZone/schoolzone_detect/last_schoolzone_resnet18.pth")
...
def main():
    ...
    print("labels: 0=none, 1=schoolzone")
