...
def parse_args():
    parser = argparse.ArgumentParser(description="Train ResNet18 cornering front-camera classifier")
    parser.add_argument("--dataset-dir", default="Cornering/corner_detect/dataset")
    parser.add_argument("--best-model-path", default="Cornering/corner_detect/best_corner_detect_resnet18.pth")
    parser.add_argument("--last-model-path", default="Cornering/corner_detect/last_corner_detect_resnet18.pth")
...
def main():
    ...
    print("labels: 0=none, 1=cornering")
